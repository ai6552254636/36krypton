...
public class RecommendListViewAdapter extends BaseAdapter{
    ...
    ArrayList<RecommendBean.T1348647909107Bean> beanArrayList ;

    public void setBeanArrayList(ArrayList<RecommendBean.T1348647909107Bean> beanArrayList) {
...
//        viewholder.mTV2.setText(finalTime);
        ...
        VolleySingleton.getInsatance().getImage(beanArrayList.get(i).getImg(),viewholder.mIV);
        viewholder.mTV.setText(beanArrayList.get(i).getTitle());
